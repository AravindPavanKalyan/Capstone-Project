...
export class CommentsComponent implements OnInit {
  ...
  public onCommentFormSubmit(values: any) {
    if (this.commentForm.valid) {
      if (values.rate) {
        ...
        this.postCommentForm(commentFormData).subscribe((res) => {
          console.log("res", res);
  ...
  private commentFormApi = "http://localhost:8080/savereview";
  public postCommentForm(commentFormData: any): Observable<any> {
    console.log('commentFormData', commentFormData);
